...
build-optimized: ## Build with maximum compression and optimization
        NODE_ENV=production node scripts/build-optimized.js

build-compressed: build ## Build and compress all static assets
...
prepare-deploy: lint type-check build-compressed ## Prepare for deployment with compression (lint, type-check, build, compress)
