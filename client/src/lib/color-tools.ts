...
export function rgbToHsl(rgb: RGB): HSL {
  ...
  if (max !== min) {
    ...
    switch (max) {
      case r: h = (g - b) / d + (g < b ? HUE_SIXTH : 0); break;
...
export function getAllPaletteTypes() {
  return [
    { key: 'complementary', name: 'Complementary', generator: generateComplementary },
    { key: 'triadic', name: 'Triadic', generator: generateTriadic },
    { key: 'analogous', name: 'Analogous', generator: generateAnalogous },
    { key: 'monochromatic', name: 'Monochromatic', generator: generateMonochromatic },
    { key: 'tetradic', name: 'Tetradic', generator: generateTetradic },
    { key: 'splitComplementary', name: 'Split Complementary', generator: generateSplitComplementary },
    { key: 'material', name: 'Material Design', generator: generateMaterialPalette }
  ];
}
