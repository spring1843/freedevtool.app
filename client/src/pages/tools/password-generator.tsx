...
import { Copy, Check, RefreshCw, Shield, Eye, EyeOff, RotateCcw } from "lucide-react";
...
export default function PasswordGenerator() {
  const { fields, updateField, resetFields } = usePersistentForm('password-generator', {
    passwords: [] as string[],
    passwordCount: 1,
    length: [16] as number[],
  ...
  const { passwords, passwordCount, length, includeUppercase, includeLowercase, includeNumbers, includeSymbols, excludeSimilar, excludeAmbiguous, showStrength } = fields;
  ...
  const assessPasswordStrength = (password: string): PasswordStrength => {
    ...
    const strengthLevels = [
      { score: 0, description: "Very Weak", color: "text-red-600", bgColor: "bg-red-100" },
      { score: 1, description: "Weak", color: "text-red-500", bgColor: "bg-red-50" },
      { score: 2, description: "Fair", color: "text-orange-500", bgColor: "bg-orange-50" },
      { score: 3, description: "Good", color: "text-yellow-500", bgColor: "bg-yellow-50" },
      { score: 4, description: "Strong", color: "text-green-500", bgColor: "bg-green-50" },
      { score: 5, description: "Very Strong", color: "text-green-600", bgColor: "bg-green-100" },
    ];
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              max="100"
              value={passwordCount}
              onChange={(e) => updateField('passwordCount', Math.min(100, Math.max(1, parseInt(e.target.value) || 1)))}
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateField('includeUppercase', checked as boolean)}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateField('includeLowercase', checked as boolean)}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateField('includeNumbers', checked as boolean)}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateField('includeSymbols', checked as boolean)}
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateField('excludeSimilar', checked as boolean)}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => updateField('excludeAmbiguous', checked as boolean)}
                  data-testid="exclude-ambiguous-checkbox"
                />
                <Label htmlFor="exclude-ambiguous">Exclude Ambiguous Characters ({ }, [ ], ( ), etc.)</Label>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => updateField('showStrength', checked as boolean)}
          ...
          <div className="pt-4 flex gap-3">
            ...
            >
              ...
              Generate {passwordCount === 1 ? 'Password' : `${passwordCount} Passwords`}
            </Button>
            <Button
              onClick={handleReset}
              variant="outline"
          ...
          <CardContent>
            <div className="space-y-3">
              {passwords.map((password, index) => {
                const strength = showStrength ? assessPasswordStrength(password) : null;
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-slate-500">Password #{index + 1}</span>
                      <div className="flex items-center space-x-2">
                        {strength ? <span className={`text-xs px-2 py-1 rounded ${strength.bgColor} ${strength.color}`}>
                    ...
                    {strength ? <div className="flex items-center space-x-2">
