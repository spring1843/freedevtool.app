  ...
  "Conversions": {
    ...
    tools: [
      ...
      { 
        ...
        description: "Convert between units of weight, distance, area, volume, pressure"
      },
      { 
        name: "URL to JSON", 
        path: "/tools/url-to-json", 
        shortcut: "Ctrl+Shift+URL",
        description: "Convert URLs to JSON with parameter parsing and TLD lookup"
      },
      { 
        name: "CSV to JSON", 
  ...
  "Formatters": {
    ...
    tools: [
      ...
      { 
        ...
        shortcut: "Ctrl+H",
        description: "Beautify HTML with proper indentation and validate for errors"
      },
      { 
        name: "YAML Formatter", 
  ...
  "Hardware": {
    ...
    tools: [
      ...
      { 
        ...
        shortcut: "Ctrl+Shift+M",
        description: "Test microphone with audio level monitoring and recording"
      },
      { 
        name: "Keyboard Test", 
...
export function getDemoTools(): Array<{ name: string; path: string; description: string }> {
