    ...
    return (
      <div className={`inline-flex items-center bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg px-3 py-2 ${className}`}>
        ...
        <span className="text-sm font-medium text-green-700 dark:text-green-400">
          <a href="https://github.com/spring1843/FreeDevTool.App?tab=readme-ov-file#tenets" target="_blank" className="hover:underline" rel="noreferrer">Secure</a>, and <a href="https://github.com/spring1843/FreeDevTool.App" target="_blank" className="hover:underline" rel="noreferrer">Open Source</a>
        </span>
      </div>
    );
  }
