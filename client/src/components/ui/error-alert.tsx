...
export function ErrorAlert({ error, warnings = [], className = "mb-6" }: ErrorAlertProps) {
  ...
  if (warnings.length > 0) {
    return (
      <Alert className={`border-yellow-200 bg-yellow-50 dark:bg-yellow-900/20 ${className}`}>
