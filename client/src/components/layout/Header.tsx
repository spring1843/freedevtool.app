  ...
  return (
    <TooltipProvider>
      ...
      <div className="w-full px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3 flex-shrink-0">
            <div className="flex items-center space-x-3">
              ...
              >
                <span className="text-white text-sm font-bold transition-transform duration-300">FD</span>
              </div>
        ...
        {/* Mobile Search Bar */}
        {isMobileSearchOpen ? <div className="md:hidden border-t border-slate-200 dark:border-slate-700 p-4 relative z-50" ref={searchRef}>
